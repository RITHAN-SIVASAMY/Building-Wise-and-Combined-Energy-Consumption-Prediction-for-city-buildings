...
# Define Stacked LSTM with Bidirectional and Unidirectional Layers
class LSTMEnergyModel(nn.Module):
    def __init__(self, input_size, hidden_size1=128, hidden_size2=64, dropout=0.2):
        ...
        # Second layer: Unidirectional LSTM
        self.lstm2 = nn.LSTM(hidden_size1 * 2, hidden_size2, batch_first=True)  # *2 for bidirectional input
        self.dropout2 = nn.Dropout(dropout)
        self.fc1 = nn.Linear(hidden_size2, 32)  # Unidirectional output
        self.relu = nn.ReLU()
